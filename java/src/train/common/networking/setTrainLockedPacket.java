...
public class setTrainLockedPacket implements IMessage
{
	private int entityID = 0;
	private boolean locked = false;
	public setTrainLockedPacket() {}
	public setTrainLockedPacket(AbstractTrains train, boolean locked)
	{
	...
	public static class Handler implements IMessageHandler<setTrainLockedPacket, IMessage>
	{
		@Override
		public IMessage onMessage(setTrainLockedPacket message, MessageContext ctx)
		{
