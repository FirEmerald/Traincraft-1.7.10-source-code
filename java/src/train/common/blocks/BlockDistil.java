...
public class BlockDistil extends BlockContainer {
	...
	{
		return Item.getItemFromBlock(BlockData.distilIdle.block);
	}
	...
	public static void updateDistilBlockState(boolean flag, World world, int i, int j, int k) {
		...
		if (flag) {
			world.setBlock(i, j, k, BlockData.distilActive.block);
		}
		else {
			world.setBlock(i, j, k, BlockData.distilIdle.block);
		}
