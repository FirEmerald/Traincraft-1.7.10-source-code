...
public class TileTCRail extends TileEntity {
	...
	public void setSwitchState(boolean state, boolean manualOverride) {
		...
		PacketHandler.sendPacketToClients(PacketHandler.getTEPClient(this), worldObj, xCoord, yCoord, zCoord, 50D);
	}
    ...
    public void onDataPacket(NetworkManager net, S35PacketUpdateTileEntity pkt)
    {
    	...
    	this.hasModel = tag.getBoolean("hasModel");
    	this.switchActive = tag.getBoolean("state");
    	this.idDrop = Item.getItemById(tag.getInteger("item"));
    }
	...
	public void handlePacketDataFromServer(byte orientation, String type, boolean hasModel, boolean switchActive, int idDropped) {
		...
		this.idDrop = Item.getItemById(idDropped);
	}
