...
public class EntityRotativeDigger extends Entity implements IInventory {
	...
	public boolean attackEntityFrom(DamageSource damagesource, float i) {
		...
		if (boatCurrentDamage > 40) {
			...
			//dropItemWithOffset(ItemData.minecartRotativeDigger.item.shiftedIndex, 1, 0.0F);
	...
	public void onUpdate() {
		...
		/*if (fuel <= 0) { if (zeppInvent[0] != null && zeppInvent[0].itemID == ItemData.refinedFuel.item.shiftedIndex) { fuel = ConfigHandler2.ZeppelinCoal; this.dataWatcher.updateObject(20, fuel); decrStackSize(0, 1); } } */
	...
	private void playMiningEffect(Vec3 pos)
	{
		...
		if (block != null)
		{
			Minecraft.getMinecraft().effectRenderer.addBlockHitEffects((int) pos.xCoord, (int) pos.yCoord, (int) pos.zCoord, getSideFromYaw());
		}
	}
	...
	public boolean interactFirst(EntityPlayer entityplayer) {
		...
		if (var2 != null && var2.getItem() == ItemData.refinedFuel.item) {
			if (--var2.stackSize == 0) {
