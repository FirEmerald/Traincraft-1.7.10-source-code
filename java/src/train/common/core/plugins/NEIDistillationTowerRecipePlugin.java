...
public class NEIDistillationTowerRecipePlugin extends FurnaceRecipeHandler{
	public class SmeltingPair extends CachedRecipe
    {
        ...
        public List<PositionedStack> getOtherStacks()
        {
            ...
            PositionedStack stackPlastic = new PositionedStack(new ItemStack(ItemData.rawPlastic.item,1,-1), 111, 56);
            if(stack != null)
                stacks.add(stack);
	...
	private static final double zLevel = -100;
	@Override
    ...
    public void drawBackground(int recipe)
    {
        ...
        changeTexture(new ResourceLocation(getGuiTexture()));
    ...
    private static void removeFuelsDistil()
    {
        ...
        efuelsDistil.add(Block.getIdFromBlock(Blocks.brown_mushroom_block));
        efuelsDistil.add(Block.getIdFromBlock(Blocks.red_mushroom_block));
