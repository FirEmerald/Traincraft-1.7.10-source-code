...
public class PluginRailcraft implements IPlugin {
	...
	private void initItems() {
		ItemData.steelRail.item = new ItemTrain();
		ItemData.copperRail.item = new ItemTrain();

		ItemData.steelRail.item.setUnlocalizedName(ItemData.steelRail.name());
		ItemData.copperRail.item.setUnlocalizedName(ItemData.copperRail.name());
	...
	private void addTrackRecipes() {
		if(items.containsKey(names[2]) && items.containsKey(names[3]) && items.containsKey(names[4])&&items.containsKey(names[5])&&items.containsKey(names[6])&&items.containsKey(names[7])&&items.containsKey(names[8])){
			if (TrackIDs.COUPLER_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.COUPLER_TRACK.getTrackSpec().getItem(TrackIDs.COUPLER_TRACK.getRecipeOutput()), new Object[] { "#R#", "#X#", "# #", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemData.stake.item });
			if (TrackIDs.ANIMAL_BOARDING_TRACK.getTrackSpec() != null)
			...
			if (TrackIDs.DETECTOR_ALL_LOCOMOTIVES.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_ALL_LOCOMOTIVES.getTrackSpec().getItem(TrackIDs.DETECTOR_ALL_LOCOMOTIVES.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemData.controls.item, Character.valueOf('E'), ItemData.electronicCircuit.item });
			if (TrackIDs.DETECTOR_DIESEL_LOCOMOTIVES.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_DIESEL_LOCOMOTIVES.getTrackSpec().getItem(TrackIDs.DETECTOR_DIESEL_LOCOMOTIVES.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemData.diesel.item, Character.valueOf('E'), ItemData.electronicCircuit.item });
			if (TrackIDs.DETECTOR_FREIGHT.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_FREIGHT.getTrackSpec().getItem(TrackIDs.DETECTOR_FREIGHT.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), Blocks.chest, Character.valueOf('E'), ItemData.electronicCircuit.item });
			if (TrackIDs.DETECTOR_PASSENGER.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_PASSENGER.getTrackSpec().getItem(TrackIDs.DETECTOR_PASSENGER.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemData.seats.item, Character.valueOf('E'), ItemData.electronicCircuit.item });
			if (TrackIDs.DETECTOR_STEAM_LOCOMOTIVES.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_STEAM_LOCOMOTIVES.getTrackSpec().getItem(TrackIDs.DETECTOR_STEAM_LOCOMOTIVES.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemData.ironFirebox.item, Character.valueOf('E'), ItemData.electronicCircuit.item });
			if (TrackIDs.DETECTOR_TANK_CARTS.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_TANK_CARTS.getTrackSpec().getItem(TrackIDs.DETECTOR_TANK_CARTS.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), Items.water_bucket, Character.valueOf('E'), ItemData.electronicCircuit.item });
			if (TrackIDs.ENERGY_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.ENERGY_TRACK.getTrackSpec().getItem(TrackIDs.ENERGY_TRACK.getRecipeOutput()), new Object[] { "#X#", "#R#", "#P#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[7]), Character.valueOf('X'), ItemData.copperWireFine.item, Character.valueOf('P'), Items.ender_pearl});
			if (TrackIDs.STEEL_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.STEEL_TRACK.getTrackSpec().getItem(TrackIDs.STEEL_TRACK.getRecipeOutput()), new Object[] { "# #", "#R#", "# #", Character.valueOf('#'), ItemData.steelRail.item, Character.valueOf('R'), items.get(names[7]) });
			if (TrackIDs.COPPER_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.COPPER_TRACK.getTrackSpec().getItem(TrackIDs.COPPER_TRACK.getRecipeOutput()), new Object[] { "# #", "#R#", "# #", Character.valueOf('#'), ItemData.copperRail.item, Character.valueOf('R'), items.get(names[7]) });
			if (TrackIDs.LOCO_SPEED_CONTROLLER.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.LOCO_SPEED_CONTROLLER.getTrackSpec().getItem(TrackIDs.LOCO_SPEED_CONTROLLER.getRecipeOutput()), new Object[] { "#R#", "#X#", "#X#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemData.controls.item });
			if (TrackIDs.LOCO_HOLDING_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.LOCO_HOLDING_TRACK.getTrackSpec().getItem(TrackIDs.LOCO_HOLDING_TRACK.getRecipeOutput()), new Object[] { "#R#", "#P#", "#X#", Character.valueOf('#'), ItemData.steelRail.item, Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemData.controls.item, Character.valueOf('P'), Blocks.stone_pressure_plate });
			if (TrackIDs.STATION_TRACK.getTrackSpec() != null)
			...
			if (TrackIDs.HORN_ALL_LOCOMOTIVES.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.HORN_ALL_LOCOMOTIVES.getTrackSpec().getItem(TrackIDs.HORN_ALL_LOCOMOTIVES.getRecipeOutput()), new Object[] { "#R#", "#S#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('S'), Items.sign, Character.valueOf('E'), ItemData.electronicCircuit.item });
		...
		if (copper != null && copper.size() >= 0) {
			for (int i = 0; i < copper.size(); i++) {
				RailcraftCraftingManager.rollingMachine.addRecipe(new ItemStack(ItemData.copperRail.item, 8), new Object[] { "X X", "X X", "X X", Character.valueOf('X'), copper.get(i) });
			}
		}
		ArrayList<ItemStack> steel = OreDictionary.getOres("ingotSteel");
		if (steel != null && steel.size() >= 0) {
			for (int t = 0; t < steel.size(); t++) {
				RailcraftCraftingManager.rollingMachine.addRecipe(new ItemStack(ItemData.steelRail.item, 16), new Object[] { "X X", "I I", "X X", Character.valueOf('X'), steel.get(t), Character.valueOf('I'), Items.iron_ingot });
			}
		}
	}
