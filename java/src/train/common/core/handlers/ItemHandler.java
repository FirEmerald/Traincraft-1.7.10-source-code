...
public class ItemHandler {
	...
	public static boolean handleFreight(Entity entity, ItemStack itemstack) {
		...
		Block block = null;
		if (itemstack.getItem() instanceof ItemBlock)/* && itemstack.itemID < 256 && itemstack.itemID > 421*/
		{
		...
		if(entity instanceof EntityBoxCartUS) {
        	...
        	if(itemstack.getItem() == Items.wheat || itemstack.getItem() == Items.wheat_seeds || itemstack.getItem() == Items.melon_seeds || itemstack.getItem() == Items.pumpkin_seeds) {
        		return true;
        	}
