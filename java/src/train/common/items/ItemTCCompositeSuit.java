...
public class ItemTCCompositeSuit extends ItemTCArmor {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		if(stack.getItem() == ItemData.helmet_suit_paintable.item || stack.getItem() == ItemData.jacket_suit_paintable.item || stack.getItem() == ItemData.boots_suit_paintable.item){
			return Info.resourceLocation+":"+Info.armorPrefix+"composite_suit_"+layer+".png";
		}else if(stack.getItem() == ItemData.pants_suit_paintable.item){
