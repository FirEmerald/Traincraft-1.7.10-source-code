...
public class ItemTCArmor extends ItemArmor
{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		...
		if (stack.getItem() == ItemData.overalls.item) {
			return Info.resourceLocation+":"+Info.armorPrefix + "blue_overalls.png";
		}
		else if (stack.getItem() == ItemData.jacket.item) {
			return Info.resourceLocation+":"+Info.armorPrefix + "orange_jacket.png";
		}
		else if(stack.getItem() == ItemData.hat.item){
			return Info.resourceLocation+":"+Info.armorPrefix + "blue_hat.png";

		}
		else if(stack.getItem() == ItemData.hat_ticketMan_paintable.item || stack.getItem() == ItemData.jacket_ticketMan_paintable.item){
			return Info.resourceLocation+":"+Info.armorPrefix+"ticket_man_"+layer+".png";
		}else if(stack.getItem() == ItemData.pants_ticketMan_paintable.item){
			return Info.resourceLocation+":"+Info.armorPrefix+"ticket_man_pants_"+layer+".png";
			
		}else if(stack.getItem() == ItemData.hat_driver_paintable.item || stack.getItem() == ItemData.jacket_driver_paintable.item){
			return Info.resourceLocation+":"+Info.armorPrefix+"driver_"+layer+".png";
		}else if(stack.getItem() == ItemData.pants_driver_paintable.item){
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(Info.modID.toLowerCase() + ":armour/" + ItemData.getIcon(this));
		if(color!=0){
			this.iconOverlay = iconRegister.registerIcon(Info.modID.toLowerCase() + ":armour/" + ItemData.getIcon(this) + "_overlay");
		}
	}
	@Override
