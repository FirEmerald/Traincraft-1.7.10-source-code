...
public class WorldGenWorld implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		copper = new WorldGenOres(BlockData.oreTC.block, 0, 6);
		oilSands = new WorldGenOres(BlockData.oreTC.block, 1, 20);
		petroleum = new WorldGenOres(BlockData.oreTC.block, 2, 14);
