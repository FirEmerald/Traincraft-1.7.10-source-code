...
public class ComponentVillageTrainstation extends StructureVillagePieces.Village
{
	...
	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
		...
		this.placeBlockAtCurrentPosition(world, BlockData.lantern.block, 0, 0, 2, 6, structureboundingbox);
		this.placeBlockAtCurrentPosition(world, Blocks.fence, 0, 8, 1, 6, structureboundingbox);
		this.placeBlockAtCurrentPosition(world, BlockData.lantern.block, 0, 8, 2, 6, structureboundingbox);
		...
		this.placeBlockAtCurrentPosition(world, BlockData.lantern.block, 0, 7, 4, 3, structureboundingbox);
		this.placeBlockAtCurrentPosition(world, BlockData.lantern.block, 0, 4, 4, 3, structureboundingbox);
		...
		this.placeBlockAtCurrentPosition(world, BlockData.trainWorkbench.block, 0, 7, 1, 1, structureboundingbox);
		...
		if (structureboundingbox.isVecInside(j1, k1, l1)) {
			...
			cart.setTrainOwner(UUID.nameUUIDFromBytes("VillagerJoe".getBytes()));
