...
//		this.motionZ -= dampZ;
    ...
    public void onUpdate()
    {
        ...
        {
        	int turnProgress = ObfuscationReflectionHelper.getPrivateValue(EntityMinecart.class, this, "turnProgress", "field_70510_h");
        	double minecartX = ObfuscationReflectionHelper.getPrivateValue(EntityMinecart.class, this, "minecartX", "field_70511_i");
        	double minecartY = ObfuscationReflectionHelper.getPrivateValue(EntityMinecart.class, this, "minecartY", "field_70509_j");
        	double minecartZ = ObfuscationReflectionHelper.getPrivateValue(EntityMinecart.class, this, "minecartZ", "field_70514_an");
        	double minecartYaw = ObfuscationReflectionHelper.getPrivateValue(EntityMinecart.class, this, "minecartYaw", "field_70512_ao");
        	double minecartPitch = ObfuscationReflectionHelper.getPrivateValue(EntityMinecart.class, this, "minecartPitch", "field_70513_ap");
            if (turnProgress > 0)
            {
                double d0 = this.posX + (minecartX - this.posX) / (double)turnProgress;
                double d1 = this.posY + (minecartY - this.posY) / (double)turnProgress;
                double d2 = this.posZ + (minecartZ - this.posZ) / (double)turnProgress;
                double d3 = MathHelper.wrapAngleTo180_double(minecartYaw - (double)this.rotationYaw);
                this.rotationYaw = (float)((double)this.rotationYaw + d3 / (double)turnProgress);
                this.rotationPitch = (float)((double)this.rotationPitch + (minecartPitch - (double)this.rotationPitch) / (double)turnProgress);
                --turnProgress;
            ...
            ObfuscationReflectionHelper.setPrivateValue(EntityMinecart.class, this, turnProgress, "turnProgress", "field_70510_h");
        }
        else
        {
            ...
            if (BlockRailBase.func_150049_b_(worldObj, x, y - 1, z) || worldObj.getBlock(x, y - 1, z) == BlockData.tcRail.block || worldObj.getBlock(x, y - 1, z) == BlockData.tcRailGag.block) {
    			i--;
    			y--;
    		}
            ...
            boolean isInReverse = ObfuscationReflectionHelper.getPrivateValue(EntityMinecart.class, this, "isInReverse", "field_70499_f");
            ...
            ObfuscationReflectionHelper.setPrivateValue(EntityMinecart.class, this, isInReverse, "isInReverse", "field_70499_f");
	...
	{
		return new GameProfile(entityUniqueID, null);
	}
}
