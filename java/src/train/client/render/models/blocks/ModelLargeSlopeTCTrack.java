...
public class ModelLargeSlopeTCTrack extends ModelBase {
	...
	public ModelLargeSlopeTCTrack() {
		modeltrack = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_slope.obj"));
		modelLargeSlopeWood = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "supports_wood.obj"));
		modelLargeSlopeBallast = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "supports_ballast.obj"));
	}
