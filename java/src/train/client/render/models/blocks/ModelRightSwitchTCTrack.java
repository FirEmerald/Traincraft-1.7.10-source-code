...
public class ModelRightSwitchTCTrack extends ModelBase {
	...
	public ModelRightSwitchTCTrack() {
		modelMediumRightSwitchActive = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_switch_small_active.obj"));
		modelMediumRightSwitchInactive = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_switch_small_inactive_new.obj"));
		modelMediumRightParallelSwitchInactive = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_switch_parallel_inactive.obj"));
		modelMediumRightParallelSwitchActive = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_switch_parallel_active.obj"));
		modelLargeRightSwitchActive = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_switch_medium_active.obj"));
		modelLargeRightSwitchInactive = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_switch_medium_inactive.obj"));
