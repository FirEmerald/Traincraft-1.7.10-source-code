...
public class ModelLeftTurnTCTrack extends ModelBase {
	...
	public ModelLeftTurnTCTrack() {
		modelMediumLeftTurn = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_curve_medium.obj"));
		modelLargeLeftTurn = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_curve_big.obj"));
		modelVeryLargeLeftTurn = AdvancedModelLoader.loadModel(new ResourceLocation(Info.resourceLocation, Info.modelPrefix + "track_curve_very_big.obj"));
	}
