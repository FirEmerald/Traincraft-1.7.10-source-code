...
public class HUDloco extends GuiScreen {
	...
	private void renderBG(Locomotive rcCar) {
		...
		drawTexturedModalRect(0, 0, 0, 150, 137, 90);
	...
	private void renderText(Locomotive loco) {
		...
		GL11.glEnable(32826);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		fontRendererObj.drawStringWithShadow("Speed:", 96, 7 + (h), 0xFFFFFF);
		fontRendererObj.drawStringWithShadow("  " + ((int) Math.abs(((float) (speed)))) + "", 96, 18 + (h), 0xFFFFFF);
		fontRendererObj.drawStringWithShadow(" " + "Km/h", 96, 29 + (h), 0xFFFFFF);

		if (loco.canOverheat()) {
			fontRendererObj.drawStringWithShadow("State: " + ((Locomotive) loco).getState(), 40, 80, 0xFFFFFF);
		}
		GL11.glDisable(32826);
		GL11.glDisable(3042 /* GL_BLEND */);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
	...
	private void renderFuelBar(Locomotive loco) {
		 ...
		 */
		if (!(loco instanceof SteamTrain)) {
			drawTexturedModalRect(18, 11, 148, 150 + l, 7, t);// l max = 70
		}
		else {
			drawTexturedModalRect(24, 17, 154, 170 + l, 9, t);// l max = 70
		}
	...
	private void renderWaterBar(Locomotive loco) {
		...
		GL11.glEnable(32826);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		drawTexturedModalRect(60, 17, 190, 169 + l_Scaled, 6, t);// l max = 49
		GL11.glDisable(32826);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		GL11.glDisable(3042 /* GL_BLEND */);
	...
	private void renderSpeedometer(Locomotive loco) {
		 ...
		 */
		if (!(loco instanceof SteamTrain)) {
			drawTexturedModalRect(65, 37 - ((int) speedScaled) + (20), 163, 150, 30, 5);// l max = 70
		}
		else {
			drawTexturedModalRect(74, 37 - ((int) speedScaled) + (20), 177, 149, 16, 8);// l max = 70
		}
		GL11.glDisable(32826);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		GL11.glDisable(3042);
	...
	private void renderOverheating(Locomotive loco) {
		 ...
		 */
		if (!(loco instanceof SteamTrain)) {
			drawTexturedModalRect(48, 37 - ((int) overheatScaled) + (20), 169, 158, 23, 5);//

		}
		else {
			drawTexturedModalRect(46, 17, 176, (int) (169 + overheatScaled), 5, t);// l max = 49
		}
		GL11.glDisable(32826);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		GL11.glDisable(3042 /* GL_BLEND */);
