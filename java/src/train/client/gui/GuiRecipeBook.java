...
public class GuiRecipeBook extends GuiScreen {
	...
	public GuiRecipeBook(EntityPlayer par1EntityPlayer, ItemStack par2ItemStack) {
		...
		addPage("Welcome to the Traincraft guide! \n \n" + "This book contains everything you need to know about Traincraft.\n" + "" + "Authors: Spitfire4466, Mrbrutal\n" + "Bukkit port: DV8FromTheWorld.\n" + "\n" + "Modelers: DAYdiecast, helldiver, BlockStormTwo, ChandlerBingUA.\n" + "Thanks to CovertJaguar for his help and a great API.\n", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartLocoBR80_DB.item), 20, 16));
				add(new StackToDraw(new ItemStack(BlockData.trainWorkbench.block), 170, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartCabooseWork.item), 60, 175));
				add(new StackToDraw(new ItemStack(ItemData.minecartTankWagon_DB.item), 80, 175));
				add(new StackToDraw(new ItemStack(ItemData.minecartFlatCartRail_DB.item), 100, 175));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightWagon_DB.item), 120, 175));
				add(new StackToDraw(new ItemStack(ItemData.minecartPassengerBlue.item), 140, 175));
				add(new StackToDraw(new ItemStack(ItemData.minecartV60_DB.item), 160, 175));
			}
		});
		addPage("World generation:\n\n By default, petrol and oil sands will be generated in the world. If you don't want them, open Traincraft.cfg and change the line ENABLE_ORE_SPAWN from true to false." + "Only the new ores will generate, the old ones can be transformed into the new ones in a crafting table.", "", "right", new ArrayList<StackToDraw>() {
			{ 
				add(new StackToDraw(new ItemStack(BlockData.oreTC.block, 1, 1), 60, 150));
				add(new StackToDraw(new ItemStack(BlockData.oreTC.block, 1, 2), 120, 150));
			}
		});
		...
		addPage("Use the W and S keys to move the locomotive forwards or backwards, respectively.\n" + "Press H in the locomotive to activate the whistle.\n" + "In the Work Carts, press R to open up the Crafting Table and F for the Furnace.\n" + "", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartLocoBR80_DB.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartGP7Red.item), 170, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartLocoCherepanov.item), 40, 145));
				add(new StackToDraw(new ItemStack(ItemData.minecartWork.item), 60, 145));
				add(new StackToDraw(new ItemStack(ItemData.minecartCabooseWork.item), 80, 145));
				add(new StackToDraw(new ItemStack(ItemData.minecartLocoForneyRed.item), 100, 145));
				add(new StackToDraw(new ItemStack(ItemData.minecartShunter.item), 120, 145));
				add(new StackToDraw(new ItemStack(ItemData.minecartLocoBR01_DB.item), 140, 145));
			}
		});
		addPage("Zeppelin:\n" + "Right click on the Zeppelin to enter/leave it. \n" + "Inside, press R to open its GUI. \n" + "Use the WASD keys to move the zeppelin around. \n" + "Press once Y to ascend or X to descend, To lock altitude, press C. \n" + "", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.airship.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.balloon.item), 170, 16));
				add(new StackToDraw(new ItemStack(ItemData.propeller.item), 40, 135));
				add(new StackToDraw(new ItemStack(ItemData.steamengine.item), 60, 135));
		...
		addPage("Fuel:\n" + "Steam locomotives need coal and water.\n" + "Tenders can only hold coal and water. Attach them to a steam locomotive, they will provide fuel and water for the loco.\n" + "Diesel locos need diesel canisters (from distillation tower) or fuel from BC and Forestry.\n", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartTender.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartLocomogulBlue.item), 170, 16));
				...
				add(new StackToDraw(new ItemStack(ItemData.diesel.item), 120, 155));
				add(new StackToDraw(new ItemStack(ItemData.refinedFuel.item), 140, 155));
			}
		});
		...
		addPage("Electric locomotives need redstone or Re-Batteries, the can also be powered by Electric tracks (requires Universal Electricity).\n" + "\n" + "Heat:\n" + "Heat level is indicated by the heat bar in the HUD.\n" + "Heat level will go to a normal state when the train is fueled but don't forget to put water in steam locomotive or it will overheat very fast.\n", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartBR_E69.item), 20, 16));
		...
		addPage("Heat level will go down to cold when there is no more fuel:\n" + "Wait until the locomotive has heated up before trying to move.\n" + "Be carefull, overheating will cause explosions...\n" +
			...
			{
				add(new StackToDraw(new ItemStack(ItemData.firebox.item), 20, 16));
		...
		addPage("Minecraft Horse Power - Mhp:\n\n" + "Locomotives have different pulling abilities represented by their 'power' in Mhp.\n" + "Each cart has a mass in tons which will affect the locomotive depending on its power.\n" + "Mass pulled affects the maximum speed, the brake rate and accelerate rate, as well as fuel consumption.\n" + "", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartLocoBR01_DB.item), 40, 165));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 60, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightCart2.item), 80, 165));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 100, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightClosed.item), 120, 165));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 140, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartWatertransp.item), 160, 165));
			}
		});
		...
		addPage("Pulling:\n" + "Right click both carts with a stake in your hand, it will say 'Attaching mode on', then make them collide and it will say 'Attached'.\n" + "Locomotives have pulling capabilities, don't make too long trains with weak locomotives. Stats of the locomotive will be affected." + " (they can be seen on the top left corner when you open the locomotive's inventory).\n", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartCaboose.item), 40, 165));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 60, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartBoxCartUS.item), 80, 165));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 100, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFlatCartLogs_DB.item), 120, 165));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 140, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartCD742.item), 160, 165));
			}
		});
		addPage("Chunk Loading:\n\n" + "Each rolling stock can load one chunk around itself.\n" + "To start chunk loading, right click with chunk loader activator on the rolling stock.\n" + "To stop chunk loading, right click again.\n", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.chunkLoaderActivator.item), 20, 16));
		...
		addPage("Stock car:\n\n" + "The stock car is the only rolling stock that can be ridden by any animals and mobs.\n" + "To fill the stock car, either collide the animal with the car or use the animal/mob boarding tracks (Railcraft required).\n" + "To empty the car, use the disembark track (Railcraft required).\n", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartStockCar.item), 20, 16));
		...
		addPage("Builder I:\n\n" + "The tracks builder has a very special inventory, in order to start it you must provide:\n" + "Ballast in the slot under it (planks, gravel, stone, ...).\n" + "Coal in the fuel slot, Tracks in the slot under the fuel slot." + "The slot on the right of the builder will activate tunnel function when provided (not all blocks are accepted).\n", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartBuilder.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartBuilder.item), 60, 165));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 80, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightClosed.item), 100, 165));
			}
		});
		addPage("Builder II:\n\n" + "The slots on top of the builder are roof slots, the builder will build a roof when provided (not all blocks are accepted)." + "If you attach a freight cart to the builder, it will dump things in it.\n\n", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartBuilder.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartBuilder.item), 60, 125));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 80, 125));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightClosed.item), 100, 125));
			}
		});
		addPage("Limitations:\n\n" + "VERY IMPORTANT:\n" + "Long trains imply limitations: Do not try to make sharp 180 turns, leave 6 spaces between each 90 turn. " + "Otherwise weird stuff will happen especially with SD70 and very long carts.\n\n" + "Always PULL carts!, bounding boxes are bugged <=> push is crapy !", "", "right", new ArrayList<StackToDraw>() {
			{
				...
				add(new StackToDraw(new ItemStack(ItemData.minecartPower.item), 40, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFlatCartWoodUS.item), 60, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartBoxCartUS.item), 80, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartPassenger9_2class_DB.item), 100, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFlatCartLogs_DB.item), 120, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightCart2.item), 140, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartCaboose.item), 160, 165));
			}
		});
		addPage("Crafting:\n" + "All train parts are crafted in the train workbench,\n\n" + "then trains have to be assembled in the assembly tables.\n\n" + "There are three assembly tables:\n\n" + "TierI - Iron age\n" + "TierII - Steel age\n" + "TierIII - Advanced age\n", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(BlockData.trainWorkbench.block), 20, 16));
				add(new StackToDraw(new ItemStack(BlockData.assemblyTableI.block), 40, 165));
				add(new StackToDraw(new ItemStack(BlockData.assemblyTableII.block), 80, 165));
				add(new StackToDraw(new ItemStack(BlockData.assemblyTableIII.block), 140, 165));
			}
		});
		addPage("Crafting steel:\n" + "Steel is now crafted in Open Hearth Furnace, supply iron ingots and graphite in the top slots, fuel in the bottom slot \n" + "and it will cook slowly into steel.\n" + "You can also use steel from other mods or use this steel in other mods.\n", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(BlockData.openFurnaceIdle.block), 20, 16));
				add(new StackToDraw(new ItemStack(BlockData.openFurnaceActive.block), 80, 155));
				add(new StackToDraw(new ItemStack(ItemData.graphite.item), 70, 135));
				add(new StackToDraw(new ItemStack(Items.iron_ingot), 90, 135));
				add(new StackToDraw(new ItemStack(Items.coal), 80, 175));
				add(new StackToDraw(new ItemStack(ItemData.steel.item), 120, 155));
			}
		});
		...
		addPage("Making diesel:\n" + "Diesel is made in a distillation tower using petroleum or oil sands found in the world.\n" + "Insert petroleum in the top slot and fuel in the bottom slot, also try reed.\n" + "It will cook into liquid diesel and give you plastic with a random chance depending on the input.\n" + "To get diesel into canisters, you must first craft them using plastic. Then put an empty one in the top right slot.", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(BlockData.distilIdle.block), 20, 16));
				add(new StackToDraw(new ItemStack(BlockData.distilActive.block), 150, 40));
				add(new StackToDraw(new ItemStack(BlockData.oreTC.block, 1, 1), 150, 20));
				add(new StackToDraw(new ItemStack(Items.coal), 150, 60));
				add(new StackToDraw(new ItemStack(ItemData.diesel.item), 167, 40));
				add(new StackToDraw(new ItemStack(ItemData.rawPlastic.item), 182, 40));
			}
		});
		addPage("Special pull I: \n" + "You can attach two locomotives together.\n\n" + "To do that: shift+click the locomotive you want to PULL with a stake in your hand. Then fuel it and wait until it heats up.\n\n" + "Now put both locomotives in attaching mode. Then move attach them by moving one locomotive towards the other.", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartLocoBR80_DB.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 170, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartCabooseWork.item), 40, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartTankWagon_DB.item), 60, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFlatCartRail_DB.item), 80, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightWagon_DB.item), 100, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartCD742.item), 120, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartCD742.item), 140, 165));
			}
		});
		addPage("Special pull II: \n" + "Locomotives have two states: 'Can pull' and 'Can be pulled'.\n" + "'Can pull' means that the locomotive is able to pull any attach cart. But it can't be pulled.\n" + "'Can be pulled' means that the locomotive behaves like a cart and can be pulled by another locomotive (which is in 'can pull' state). Attached locomotives share power.", "", "left", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(ItemData.minecartLoco3.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.stake.item), 170, 16));
				add(new StackToDraw(new ItemStack(ItemData.minecartCD742.item), 40, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightWagon_DB.item), 60, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightWagon_DB.item), 80, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightWagon_DB.item), 100, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartFreightWagon_DB.item), 120, 165));
				add(new StackToDraw(new ItemStack(ItemData.minecartCD742.item), 140, 165));
			}
		});
		addPage("Armors I: \n" + "There are several armors in the mod.\n" +
			...
			{
				add(new StackToDraw(new ItemStack(ItemData.hat.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.hat_ticketMan_paintable.item), 170, 16));
				add(new StackToDraw(new ItemStack(ItemData.hat_driver_paintable.item), 40, 165));
				add(new StackToDraw(new ItemStack(ItemData.jacket_driver_paintable.item), 90, 165));
				add(new StackToDraw(new ItemStack(ItemData.pants_driver_paintable.item), 140, 165));
			}
		});
		addPage("Armors II: \n" + "The helmet cures poisons, helps you breathe under water, and gives night vision in dark places (not when riding an entity)\n" +
			...
			{
				add(new StackToDraw(new ItemStack(ItemData.helmet_suit_paintable.item), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.reinforcedPlates.item), 170, 16));
			}
		});
		addPage("Generators:\n" +
				...
				"","","right",new ArrayList<StackToDraw>() {
					{
						add(new StackToDraw(new ItemStack(BlockData.windMill.block, 1, 4), 20, 16));
						add(new StackToDraw(new ItemStack(BlockData.waterWheel.block, 1, 4), 170, 16));
					}
				});
		addPage("Villager\n" +
				"\n" +
				...
				"","","left",new ArrayList<StackToDraw>() {
					{
						add(new StackToDraw(new ItemStack(ItemData.jacket_driver_paintable.item, 1, 4), 20, 16));
						add(new StackToDraw(new ItemStack(ItemData.hat_driver_paintable.item, 1, 4), 170, 16));
					}
				});
		addPage("Known bugs:\n" +
		...
		addPage("Advices:\n" +
				...
				"","","left",new ArrayList<StackToDraw>() {
					{
						add(new StackToDraw(new ItemStack(ItemData.minecartTankWagon_DB.item), 20, 16));
						add(new StackToDraw(new ItemStack(BlockData.oreTC.block), 170, 16));
						add(new StackToDraw(new ItemStack(ItemData.minecartCaboose3.item), 40, 155));
						add(new StackToDraw(new ItemStack(ItemData.minecartFreightWellcar.item), 60, 155));
						add(new StackToDraw(new ItemStack(ItemData.minecartOpenWagon.item), 80, 155));
						add(new StackToDraw(new ItemStack(ItemData.minecartStockCar.item), 100, 155));
						add(new StackToDraw(new ItemStack(ItemData.minecartOpenWagon.item), 120, 155));
						add(new StackToDraw(new ItemStack(ItemData.minecartBR_E69.item), 140, 155));
					}
				});
		...
		addPage("On the next pages you will find all the train workbench recipes and assembly table recipes.\n" + "It is however strongly suggested to try to discover the recipes by yourself...\n\n" + "We hope you will enjoy the mod!\n\n" + "Spitfire4466 and MrBrutal", "", "right", new ArrayList<StackToDraw>() {
			{
				add(new StackToDraw(new ItemStack(BlockData.trainWorkbench.block), 20, 16));
				add(new StackToDraw(new ItemStack(ItemData.hat.item), 40, 155));
				add(new StackToDraw(new ItemStack(ItemData.jacket.item), 90, 155));
				add(new StackToDraw(new ItemStack(ItemData.overalls.item), 140, 155));
			}
		});
