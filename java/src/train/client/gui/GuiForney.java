...
public class GuiForney extends GuiContainer {
	...
	protected void actionPerformed(GuiButton guibutton) {
		...
		if (guibutton.id == 3) {
			...
			if (((AbstractTrains) loco).riddenByEntity != null && ((AbstractTrains) loco).riddenByEntity instanceof EntityPlayer && ((EntityPlayer) ((AbstractTrains) loco).riddenByEntity).getGameProfile().getId().equals(((AbstractTrains) loco).trainOwner)) {
	...
	protected void drawCreativeTabHoveringText(String str, int t, int g) {
		...
		fontRendererObj.drawStringWithShadow("Owner: " + ((AbstractTrains) loco).trainOwner.toString(), startX, startY + 40, -1);
	}
