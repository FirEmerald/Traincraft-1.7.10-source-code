...
public class GuiDistil extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		if (distilInventory.distilItemStacks[0] != null) {
			 ...
			 */
			if(distilInventory.distilItemStacks[0].getItem() == Item.getItemFromBlock(BlockData.oreTC.block) && (distilInventory.distilItemStacks[0].getItemDamage() != 1 && distilInventory.distilItemStacks[0].getItemDamage() != 2)){
				return;
			}
